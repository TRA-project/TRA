...
from app.apis.tools import save_log, get_recommend_cities
from app.models import Message, AppUser, Flight, UsersFlight, City, Province
from app.serializers import FlightSerializer, FlightDetailedSerializer, CitySerializer, ProvinceSerializer, \
    LogSerializer
