...
from user.models import Flight, UsersFlight, City, Province
from user.serializers import FlightSerializer, FlightDetailedSerializer, CitySerializer, ProvinceSerializer
